  ...
  return (
    <section className="relative">
      <div className="w-11/12 max-w-[1300px] relative mx-auto py-20">
        ...
        {/* Main Content */}
        <div className="flex flex-col md:flex-row  max-w-[800px] items-center mx-auto gap-10 mt-10">
          {/* Profile Image */}
          <div>
            <img
              src={profilePic}
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-row gap-4 items-center">
              ...
              <a
                href="https://www.linkedin.com/in/mayureshwartawade/"
                target="_blank"
                rel="noreferrer"
              >
                <img
              ...
              <a
                href="https://github.com/mayureshwartawade/"
                target="_blank"
                rel="noreferrer"
              >
                <img
            ...
            <p className="font-mullish text-xl text-gray-500 max-w-[90%] md:max-w-[420px]">
